    ...
    @unless ($formSubmitted)
        <div class="flex items-center justify-center">
            <div class="h-100 w-100 md:h-172 md:w-172 bg-gray-300 flex items-center justify-center rounded p-3">
                ...
                <div class="md:w-1/2 md:pr-4 md:pb-0 md:pb-4 md:order-2">
                                ...
                                <div class="flex items-center mx-3">
                                    <label class="flex-grow h-full w-40">
                                        <input type="text" placeholder="Page de départ" list="startOptions"
                                            wire:model.debounce.500ms="start" class="rounded w-full" x-ref="startInput">
                                    ...
                                    <button type="button" class="border-solid border-2 border-black h-full"
                                ...
                                <div class="flex items-center mx-3">
                                    <label class="flex-grow h-full w-40">
                                        <input type="text" placeholder="Page d'arrivée" list="endOptions"
                                            wire:model.debounce.500ms="end" class="rounded w-full" x-ref="endInput">
