<form wire:submit.prevent="submit" class="space-y-8 divide-y divide-gray-200">
    <div class="text-center">
        ...
        <div>
            <label>
                <input type="text" placeholder="Page de départ" list="startOptions" wire:model.debounce.500ms="start"
            ...
            <label>
                <input type="text" placeholder="Page d'arrivée" list="endOptions" wire:model.debounce.500ms="end"
